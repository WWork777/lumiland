...
const EVENTS = [
    ...
    },
    {
        ...
        weekday: 'Суббота',
        events: [
            { time: '14:00', name: 'Гавайская вечеринка!' },
        ],
    },
    {
        date: '23 июня',
        weekday: 'Вторник',
        events: [
            { time: 'Весь день', name: 'День рождения Люмика! Весь день билеты всего за 500 рублей' }
        ],
    },
    {
        date: '27 июня',
        weekday: 'Суббота',
        events: [
            { time: '14:00', name: 'День здорового ребёнка!' },
        ],
    },
    {
        date: 'Мастер-класс',
