    ...
    return (
        <header className={styles.header}>
            ...
            <div className={styles.contacts}>
                <Link href="#">
                    <Image src="/icons/vk.svg" width={36} height={36} alt="Вконтакте" />
                </Link>
                <Link href="#">
                    <Image src="/icons/whatsapp.svg" width={36} height={36} alt="Вотсап" />
                </Link>
                <Link href="#">
            ...
            >
                <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <rect width="18.8426" height="18.8426" transform="translate(8.07861 8.60218)" fill="#DCFF00" />
                    <path
            ...
            <div className={`${styles.mobileMenu} ${isMenuOpen ? styles.open : ""}`} id="mobile-nav">
                <div className={styles.mobileMenuHeader}>
                    <Image src="/icons/logo.svg" width={149} height={37} alt="lumiland" />
                    <button type="button" onClick={closeMenu} className={styles.closeButton} aria-label="Закрыть меню">
                        <span />
                        <span />
                    </button>
                </div>
