...
export default function Price() {
    ...
    return(
      ...
      <div className={styles.grid}>
        ...
        <div className={`${styles.cell} ${styles.ticket} ${styles.ticketBig}`}>
          Стандартный<br />билет
        </div>
 ...
 <h2 className={styles.title}><span>ЦЕНЫ И БИЛЕТЫ</span> В LUMILAND</h2>
  ...
  <div className={styles.block}>
    ...
    <h3 className={styles.blockTitle}> Сопровождающий детей взрослый <br />
    ...
    <h3 className={styles.blockTitle}> Дети до 1 года </h3>
        ...
        <div className={styles.table}>
         ...
         <Image 
            ...
            src="/images/Price/spinGreen.png" 
            alt='' 
            width={300}
            height={300}
        />
